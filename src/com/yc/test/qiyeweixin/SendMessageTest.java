...
import com.yc.test.qiyeweixin.send.Article;
import com.yc.test.qiyeweixin.send.FileMessage;
import com.yc.test.qiyeweixin.send.ImgMessage;
import com.yc.test.qiyeweixin.send.Media;
import com.yc.test.qiyeweixin.send.News;
import com.yc.test.qiyeweixin.send.NewsMessage;
import com.yc.test.qiyeweixin.send.Text;
import com.yc.test.qiyeweixin.send.TextMessage;
import com.yc.test.qiyeweixin.send.Textcard;
import com.yc.test.qiyeweixin.send.TextcardMessage;
import com.yc.test.qiyeweixin.send.Video;
import com.yc.test.qiyeweixin.send.VideoMessage;
import com.yc.test.qiyeweixin.send.VoiceMessage;
...
public class SendMessageTest {
	...
	public static void main(String[] args) {
		...
		TextMessage message=new TextMessage();
		//1.1非必需
		message.setTouser("MinYongCheng|LiangYue|SongGuiBin|GongWenNa|ChenJiaoYun");  //不区分大小写
		//textMessage.setToparty("1");
		//txtMsg.setTotag(totag);
		//txtMsg.setSafe(0);
		...
		//2.获取access_token:根据企业id和通讯录密钥获取access_token,并拼接请求url
		String accessToken= WeiXinUtil.getAccessToken(WeiXinParamesUtil.corpId, WeiXinParamesUtil.agentSecret).getToken();//企业微信内部部门Secret
		System.out.println("accessToken:"+accessToken);
