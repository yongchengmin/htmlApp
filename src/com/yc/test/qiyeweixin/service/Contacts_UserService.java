...
import com.yc.test.qiyeweixin.UserTest;
import com.yc.test.qiyeweixin.pojo.User;
...
public class Contacts_UserService {
	...
	public void createUser(String accessToken,User user) {
		...
		if (null != jsonObject) {  
			if (0 != jsonObject.getInt("errcode")) {  
				logger.error("创建成员失败 errcode:{} errmsg:{}"+"/n"+jsonObject.getInt("errcode")+"/n"+jsonObject.getString("errmsg"));  
			}  
		}  
	}
	...
	public void getUser(String accessToken,String userId) {
		...
		if (null != jsonObject) {  
			if (0 != jsonObject.getInt("errcode")) {  
				logger.error("获取成员失败 errcode:{} errmsg:{}"+"/n"+jsonObject.getInt("errcode")+"/n"+jsonObject.getString("errmsg"));  
			}  
		}  
	}
	...
	public void updateUser(String accessToken,User user) {
		...
		if (null != jsonObject) {  
			if (0 != jsonObject.getInt("errcode")) {  
				logger.error("更新成员失败 errcode:{} errmsg:{}"+"/n"+jsonObject.getInt("errcode")+"/n"+jsonObject.getString("errmsg"));  
			}  
		}  
	}
	...
	public void deleteUser(String accessToken,String userId) {	
		...
		if (null != jsonObject) {  
			if (0 != jsonObject.getInt("errcode")) {  
				logger.error("删除成员失败 errcode:{} errmsg:{}"+"/n"+jsonObject.getInt("errcode")+"/n"+jsonObject.getString("errmsg"));  
			}  
		}  
	}
	...
	public void batchdeleteUser(String accessToken,List<String> userIdList){
		...
		if (null != jsonObject) {  
			if (0 != jsonObject.getInt("errcode")) {  
				logger.error("批量删除成员失败 errcode:{} errmsg:{}"+"/n"+jsonObject.getInt("errcode")+"/n"+jsonObject.getString("errmsg"));  
			}  
		}  
	}
	...
	public void getDepartmentUser(String accessToken,String departmentId,String fetchChild) {
		...
		if (null != jsonObject) {  
			if (0 != jsonObject.getInt("errcode")) {  
				logger.error("获取部门成员失败 errcode:{} errmsg:{}"+"/n"+jsonObject.getInt("errcode")+"/n"+jsonObject.getString("errmsg"));  
			}  
		}  
	}
	...
	public void getDepartmentUserDetails(String accessToken,String departmentId,String fetchChild) {
		...
		if (null != jsonObject) {  
			if (0 != jsonObject.getInt("errcode")) {  
				logger.error("获取部门成员详情失败 errcode:{} errmsg:{}"+"/n"+jsonObject.getInt("errcode")+"/n"+jsonObject.getString("errmsg"));  
			}  
		}  
	}
